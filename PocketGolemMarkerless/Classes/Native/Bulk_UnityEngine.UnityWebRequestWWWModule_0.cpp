...
extern "C"  float UnityWebRequest_get_uploadProgress_m3209318331 (UnityWebRequest_t463507806 * __this, const RuntimeMethod* method) IL2CPP_METHOD_ATTR;
...
IL_0071:
		{
			KeyValuePair_2_t4030379155  L_14 = Enumerator_get_Current_m350026837((Enumerator_t3586889763 *)(&V_3), /*hidden argument*/Enumerator_get_Current_m350026837_RuntimeMethod_var);
			V_2 = L_14;
			UnityWebRequest_t463507806 * L_15 = __this->get__uwr_0();
			String_t* L_16 = KeyValuePair_2_get_Key_m3482016922((KeyValuePair_2_t4030379155 *)(&V_2), /*hidden argument*/KeyValuePair_2_get_Key_m3482016922_RuntimeMethod_var);
			String_t* L_17 = KeyValuePair_2_get_Value_m2269099694((KeyValuePair_2_t4030379155 *)(&V_2), /*hidden argument*/KeyValuePair_2_get_Value_m2269099694_RuntimeMethod_var);
			NullCheck(L_15);
...
IL_0092:
		{
			bool L_18 = Enumerator_MoveNext_m678072902((Enumerator_t3586889763 *)(&V_3), /*hidden argument*/Enumerator_MoveNext_m678072902_RuntimeMethod_var);
			if (L_18)
			{
				goto IL_0071;
			}
...
extern "C"  float WWW_get_uploadProgress_m3861654740 (WWW_t3688466362 * __this, const RuntimeMethod* method)
{
	float V_0 = 0.0f;
	float V_1 = 0.0f;
	{
		UnityWebRequest_t463507806 * L_0 = __this->get__uwr_0();
		NullCheck(L_0);
		float L_1 = UnityWebRequest_get_uploadProgress_m3209318331(L_0, /*hidden argument*/NULL);
		V_0 = L_1;
		float L_2 = V_0;
		if ((!(((float)L_2) < ((float)(0.0f)))))
		{
